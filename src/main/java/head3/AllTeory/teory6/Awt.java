package head3.AllTeory.teory6;

/**
 * Abstract Window Toolkit (AWT) – это инструментарий классов в Java, который помогает программисту
 * разрабатывать компоненты графического и графического интерфейса пользователя.
